...
import dio.desafios.model.Board;
...
import static dio.desafios.util.BoardTemplate.BOARD_TEMPLATE;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                default -> System.out.println("Opão invalida, selecione uma das opções do menu");
            }
    ...
    private static void stratGame(Map<String, String> positions) {
        ...
        List<List<Space>> spaces = spaces = new ArrayList<>();
